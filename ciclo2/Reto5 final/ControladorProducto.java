...
public class ControladorProducto implements ActionListener {
     ...
     * Crea una lista vacia Y realiza la siguientes acciones 3 veces:
     * 1    Pregunta por el producto mas costoso invocando al método 'productosPrecioMayor', 
     * 2    Lo agrega al listado 'listaMayores'
     * 3    Elimina del listado general de prodcutos 'listaProductos'
     * 
    ...
    /**
     * Gestiona eventos de clic sobre los botones validando el botón sobre el que se hace clic y ejecutando
     * el respectivo método de negocio segun el caso: 
     * 
     * Si se hace clic sobre el botón 'botonActualizar' se ejecuta el método 'actualizarProducto'
     * Si se hace clic sobre el botón 'botonAgregarProducto' se ejecuta el método 'agregarProducto'
     * Si se hace clic sobre el botón 'botonBorrar' se ejecuta el método 'borrarProducto'
     * Si se hace clic sobre el botón 'botonInformes' se ejecuta el método 'generarInforme'
